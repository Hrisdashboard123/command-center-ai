      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 px-12 text-center max-w-lg">
          <h2 className="text-3xl font-heading text-foreground mb-4 animate-fade-up">
            Access Your AI Analytics Command Center
          </h2>
          <p className="text-muted-foreground font-body text-lg" style={{ animationDelay: "0.1s" }}>
            Real-time predictive intelligence for data-driven decisions
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-fade-up">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Sign in to your analytics workspace</p>
          </div>
          ...
          <div className="card-elevated p-8">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    className="pl-10 pr-10 bg-secondary border-border text-foreground placeholder:text-muted-foreground focus:ring-primary"
                  />
                  <button
                    type="button"
            ...
            <p className="text-center text-xs text-muted-foreground mt-6">
              Protected by AI-driven data security
            </p>
          </div>
